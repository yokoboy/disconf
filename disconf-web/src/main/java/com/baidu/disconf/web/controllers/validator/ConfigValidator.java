...
//        }
    ...
    public void validateNew(ConfNewItemForm confNewForm, DisConfigTypeEnum disConfigTypeEnum) {
        ...
        // envBO
        //
        EnvBO envBO = envMgr.getById(confNewForm.getEnvId());
        if (envBO == null) {
        ...
        // key
        //
        Config config = configFetchMgr.getConfByParameter(app.getId(), envBO.getId(), confNewForm.getVersion(), confNewForm.getKey(), disConfigTypeEnum);
        if (config != null) {
